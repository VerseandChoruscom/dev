...
// Define the path to the data loader
$data_loader_path = 'data-loader.php';

// Initialize data variable in case include fails
$all_songs_data_js = 'const ALL_SONGS_DATA = [];'; 

if (file_exists($data_loader_path)) {
    // Capture the output of data-loader.php to ensure no stray output breaks the HTML
    ob_start();
    include $data_loader_path;
    $all_songs_data_js = ob_get_clean();
    
    // Check if the output starts with "const ALL_SONGS_DATA" to confirm success
    if (strpos($all_songs_data_js, 'const ALL_SONGS_DATA') !== 0) {
        $all_songs_data_js = 'const ALL_SONGS_DATA = []; console.error("PHP data loader output corrupted or failed.");';
    }
} else {
    $all_songs_data_js = 'const ALL_SONGS_DATA = []; console.error("PHP data loader file not found.");';
}
...
<body class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow py-10">
        <div class="content-container">
            ...
            <!-- START OF INDUSTRY LINKS & RESOURCES SECTION (Moved outside footer) -->
    ...
    <script>
        ...
        // This PHP code outputs the ALL_SONGS_DATA array or an error message directly.
        <?php echo $all_songs_data_js; ?> 
