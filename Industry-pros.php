...
<body class="min-h-screen flex flex-col">
    ...
    <script>
        ...
        // RESTORED: Simple include, assuming 'data-loader.php' correctly outputs 'const ALL_SONGS_DATA = [...];'
        ...
        function getSongById(id) {
            ...
            if (typeof ALL_SONGS_DATA === 'undefined' || !Array.isArray(ALL_SONGS_DATA)) {
                // If data is missing, fail silently here to prevent subsequent JS errors
                return null;
            }
        ...
        function applyMasterFilter() {
            // Check if ALL_SONGS_DATA is available (if the PHP import succeeded)
            if (typeof ALL_SONGS_DATA === 'undefined' || !Array.isArray(ALL_SONGS_DATA)) {
                // If the data is missing, we exit silently without causing a JS error cascade
                return;
            }
        ...
        window.openMusicPlayer = function(songId) {
            ...
            // FIX: Replace literal newline characters with <br> tags 
